...
call python "%SCRIPT_DIR%gen_qjs_module.py"
if %errorlevel% neq 0 (
...
set CFLAGS=-O2 -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32_WINNT=0x0501 -I"%QJS_DIR%" -I"%RL_SRC%" -I"%RL_SRC%\external\glfw\include" -I"%SCRIPT_DIR_TRIM%" -DCONFIG_VERSION=\"2025-09-13\"
